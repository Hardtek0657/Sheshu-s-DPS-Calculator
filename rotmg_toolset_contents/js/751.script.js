/*! For license information please see 751.script.js.LICENSE.txt */
"use strict";
(self.webpackChunk = self.webpackChunk || []).push([
  [751],
  {
    4751: (e, t, r) => {
      r.d(t, { WebGPURenderer: () => Se });
      var s = r(8507),
        i = r(9313),
        n = r(341),
        o = r(9104),
      ...
      class f {
        init() {
          const e = new p.k({
              uTransformMatrix: { value: new i.u(), type: "mat3x3<f32>" },
              uColor: {
            ...
            t = (0, a.v)({
              name: "graphics",
              bits: [u.F, (0, d._)(o.k), c._Q, h.b],
            });
          this.shader = new l.M({
            gpuProgram: t,
            resources: { localUniforms: e },
          });
        }
        execute(e, t) {
          const r = t.context,
            ...
            i = e.renderer,
            o = i.graphicsContext,
            { geometry: a, instructions: u } = o.getContextRenderData(r),
            d = i.encoder;
          d.setPipelineFromGeometryProgramAndState(a, s.gpuProgram, e.state),
            d.setGeometry(a);
          const c = i.globalUniforms.bindGroup;
          d.setBindGroup(0, c, s.gpuProgram);
          ...
          for (let e = 0; e < u.instructionSize; e++) {
            const t = l[e];
            if (((s.groups[1] = t.bindGroup), !t.gpuBindGroup)) {
              const e = t.textures;
              (t.bindGroup = (0, n.w)(e.textures, e.count)),
                (t.gpuBindGroup = i.bindGroup.getBindGroup(
                  t.bindGroup,
                  s.gpuProgram,
                  1
                ));
            }
            d.setBindGroup(1, t.bindGroup, s.gpuProgram),
              d.renderPassEncoder.drawIndexed(t.size, 1, t.start);
          }
        }
        destroy() {
      ...
      f.extension = { type: [s.Ag.WebGPUPipesAdaptor], name: "graphics" };
      var g = r(3391),
        m = r(4492),
        _ = r(268);
      class b {
        init() {
          const e = (0, a.v)({ name: "mesh", bits: [c.Ls, g.R, h.b] });
          this._shader = new l.M({
            gpuProgram: e,
            resources: {
              uTexture: m.g.EMPTY._source,
              uSampler: m.g.EMPTY._source.style,
              textureUniforms: {
                uTextureMatrix: { type: "mat3x3<f32>", value: new i.u() },
              },
            },
          });
        }
        execute(e, t) {
          ...
          if (s) {
            if (!s.gpuProgram)
              return void (0, _.R)("Mesh shader has no gpuProgram", t.shader);
          } else
            (s = this._shader),
              (s.resources.uTexture = t.texture.source),
              (s.resources.uSampler = t.texture.source.style),
              (s.resources.textureUniforms.uniforms.uTextureMatrix =
                t.texture.textureMatrix.mapCoord);
          const i = s.gpuProgram;
          if (
            (i.autoAssignGlobalUniforms &&
              (s.groups[0] = r.globalUniforms.bindGroup),
            i.autoAssignLocalUniforms)
          ) {
            const t = e.localUniforms;
            s.groups[1] = r.renderPipes.uniformBatch.getUniformBindGroup(t, !0);
          }
      ...
      b.extension = { type: [s.Ag.WebGPUPipesAdaptor], name: "mesh" };
      var x = r(7547);
      const y = x.U.for2d();
      class G {
        init() {
          const e = (0, a.v)({
            name: "batch",
            bits: [u.F, (0, d._)(o.k), h.b],
          });
          this._shader = new l.M({ gpuProgram: e, groups: {} });
        }
        start(e, t) {
          const r = e.renderer,
            s = r.encoder,
            i = this._shader.gpuProgram;
          (this._geometry = t),
            s.setGeometry(t),
            (y.blendMode = "normal"),
            r.pipeline.getPipeline(t, i, y);
          const n = r.globalUniforms.bindGroup;
          s.resetBindGroup(1), s.setBindGroup(0, n, i);
        }
        execute(e, t) {
          ...
          const o = s.bindGroup.getBindGroup(t.bindGroup, r, 1),
            a = s.pipeline.getPipeline(this._geometry, r, y);
          t.bindGroup._touch(s.textureGC.count),
            i.setPipeline(a),
            i.renderPassEncoder.setBindGroup(1, o),
      ...
      G.extension = { type: [s.Ag.WebGPUPipesAdaptor], name: "batch" };
      var P = r(2855),
        B = r(3864),
        v = r(5099);
      class S {
        ...
        getBindGroup(e, t, r) {
          e._updateKey();
          return this._hash[e._key] || this._createBindGroup(e, t, r);
        }
        _createBindGroup(e, t, r) {
          const s = this._gpu.device,
            ...
            o = this._renderer;
          for (const t in i) {
            const r = e.resources[t] ?? e.resources[i[t]];
            let s;
            if ("uniformGroup" === r._resourceType) {
              const e = r;
            ...
            } else if ("buffer" === r._resourceType) {
              const e = r;
              s = {
            ...
            } else if ("bufferResource" === r._resourceType) {
              const e = r;
              s = {
            ...
            } else if ("textureSampler" === r._resourceType) {
              const e = r;
              s = o.texture.getGpuSampler(e);
            } else if ("textureSource" === r._resourceType) {
              const e = r;
              s = o.texture.getGpuSource(e).createView({});
            }
            n.push({ binding: i[t], resource: s });
          }
          const a = o.shader.getProgramData(t).bindGroups[r],
            u = s.createBindGroup({ layout: a, entries: n });
          return (this._hash[e._key] = u), u;
        }
        destroy() {
      ...
      S.extension = { type: [s.Ag.WebGPUSystem], name: "bindGroup" };
      var T = r(6736);
      class C {
        constructor() {
        ...
        createGPUBuffer(e) {
          ...
          return (
            (e._updateID = 0),
            e.data && ((0, T.W)(e.data.buffer, t.getMappedRange()), t.unmap()),
      ...
      C.extension = { type: [s.Ag.WebGPUSystem], name: "buffer" };
      class U {
        constructor(e) {
      ...
      U.extension = { type: [s.Ag.WebGPUSystem], name: "colorMask" };
      class M {
        constructor(e) {
          this._renderer = e;
        }
        async init(e) {
          return (
            this._initPromise ||
              (this._initPromise = this._createDeviceAndAdaptor(e).then((e) => {
                (this.gpu = e),
      ...
      (M.extension = { type: [s.Ag.WebGPUSystem], name: "device" }),
        (M.defaultOptions = {
      ...
      class w {
        ...
        _setIndexBuffer(e) {
          ...
          const t = 2 === e.data.BYTES_PER_ELEMENT ? "uint16" : "uint32";
        ...
        restoreRenderPass() {
          ...
          this.renderPassEncoder.setViewport(n.x, n.y, n.width, n.height, 0, 1),
            this.setPipeline(t);
          for (const e in r) this._setVertexBuffer(e, r[e]);
          for (const e in i) this.setBindGroup(e, i[e], null);
      ...
      w.extension = { type: [s.Ag.WebGPUSystem], name: "encoder", priority: 1 };
      var A = r(1957);
      class E {
        constructor(e) {
        ...
        onRenderTargetChange(e) {
          ...
          t ||
            (t = this._renderTargetStencilState[e.uid] =
              { stencilMode: A.K.DISABLED, stencilReference: 0 }),
      ...
      E.extension = { type: [s.Ag.WebGPUSystem], name: "stencil" };
      var R = r(7047);
      const k = {
        i32: { align: 4, size: 4 },
        u32: { align: 4, size: 4 },
      ...
      function O(e) {
        const t = e.map((e) => ({ data: e, offset: 0, size: 0 }));
        let r = 0;
        for (let e = 0; e < t.length; e++) {
          const s = t[e];
          let i = k[s.data.type].size;
          const n = k[s.data.type].align;
          if (!k[s.data.type])
            throw new Error(
        ...
        return (r = 16 * Math.ceil(r / 16)), { uboElements: t, size: r };
      }
      var z = r(6423),
        H = r(1266);
      function F(e, t) {
        const { size: r, align: s } = k[e.data.type],
          i = (s - r) / 4;
        return `\n         v = uv.${e.data.name};\n         ${
          0 !== t ? `offset += ${t};` : ""
        }\n\n         arrayOffset = offset;\n\n         t = 0;\n\n         for(var i=0; i < ${
      ...
      function L(e) {
        return (0, z.E)(e, "uboWgsl", F, H._);
      }
      class D extends R.W {
        constructor() {
          super({ createUboElements: O, generateUboSync: L });
        }
      }
      D.extension = { type: [s.Ag.WebGPUSystem], name: "ubo" };
      var W = r(949),
        I = r(581),
        V = r(1132);
      class N {
        ...
        addEmptyGroup(e) {
          if (e > this._minUniformOffsetAlignment / 4)
            throw new Error("UniformBufferBatch: array is too large: " + 4 * e);
      ...
      class q {
        constructor(e) {
          (this._bindGroupHash = Object.create(null)),
            ...
            (this._renderer = e),
            (this._batchBuffer = new N({ minUniformOffsetAlignment: K }));
          for (let e = 0; e < 2; e++) {
            let t = V.S.UNIFORM | V.S.COPY_DST;
            0 === e && (t |= V.S.COPY_SRC),
              this._buffers.push(
                new W.h({ data: this._batchBuffer.data, usage: t })
              );
          }
        }
        renderEnd() {
        ...
        getUniformBindGroup(e, t) {
          ...
          return (
            this._renderer.ubo.syncUniformGroup(
              e,
              this._batchBuffer.data,
              s / 4
            ),
            (this._bindGroupHash[e.uid] = this._getBindGroup(s / K)),
        ...
        getUboResource(e) {
          ...
          return this._getBufferResource(r / K);
        }
        getArrayBindGroup(e) {
        ...
        _getBindGroup(e) {
          if (!this._bindGroups[e]) {
            const t = new j.T({ 0: this._getBufferResource(e) });
      ...
      q.extension = { type: [s.Ag.WebGPUPipes], name: "uniformBatch" };
      var Y = r(7084),
        X = r(7952),
        $ = r(1172);
      const Q = {
      ...
      class J {
        ...
        contextChange(e) {
          (this._gpu = e),
            this.setStencilMode(A.K.DISABLED),
        ...
        setColorMask(e) {
          this._colorMask !== e &&
            ((this._colorMask = e), this._updatePipeHash());
        }
        setStencilMode(e) {
          this._stencilMode !== e &&
            ((this._stencilMode = e),
            (this._stencilState = $.g[e]),
            this._updatePipeHash());
        }
        setPipeline(e, t, r, s) {
        ...
        getPipeline(e, t, r, s) {
          e._layoutKey ||
            ((0, Y.q)(e, t.attributeData), this._generateBufferKey(e)),
            (s = s || e.topology);
          const i = (function (e, t, r, s, i) {
            return (e << 24) | (t << 16) | (r << 10) | (s << 5) | i;
          })(e._layoutKey, t._layoutKey, r.data, r._blendModeId, Q[s]);
          return (
            this._pipeCache[i] ||
        ...
        _createPipeline(e, t, r, s) {
          const i = this._gpu.device,
            n = this._createVertexBufferLayouts(e),
            o = this._renderer.state.getColorTargets(r);
          o[0].writeMask =
            this._stencilMode === A.K.RENDERING_MASK_ADD ? 0 : this._colorMask;
          const a = this._renderer.shader.getProgramData(t).pipeline,
            u = {
              vertex: {
          ...
          return i.createRenderPipeline(u);
        }
        _getModule(e) {
        ...
        _generateBufferKey(e) {
          ...
          const i = t.join("");
          return (e._layoutKey = (0, X.X)(i, "geometry")), e._layoutKey;
        }
          ...
          return (
            e.buffers.forEach((r) => {
              ...
              for (const t in e.attributes) {
                ...
                n.buffer === r &&
                  ((s.arrayStride = n.stride),
                  (s.stepMode = n.instance ? "instance" : "vertex"),
                  i.push({
                    shaderLocation: n.location,
                    offset: n.offset,
                    format: n.format,
                  }));
              }
        ...
        _updatePipeHash() {
          const e =
            ((t = this._stencilMode),
            (r = this._multisampleCount),
            (s = this._colorMask),
            (i = this._depthStencilAttachment),
            (s << 6) | (t << 3) | (i << 1) | r);
          var t, r, s, i;
      ...
      J.extension = { type: [s.Ag.WebGPUSystem], name: "pipeline" };
      var Z = r(7238),
        ee = r(1257),
        te = r(4884),
        re = r(6932);
      ...
      class ie {
        ...
        copyToTexture(e, t, r, s, i) {
          const n = this._renderer,
            ...
            a = n.texture.getGpuSource(t.source);
          return (
        ...
        startRenderPass(e, t = !0, r, s) {
          const i = this._renderTargetSystem.getGpuRenderTarget(e),
            n = this.getDescriptor(e, t, r);
          (i.descriptor = n),
            this._renderer.pipeline.setRenderTarget(i),
            this._renderer.encoder.beginRenderPass(i),
        ...
        getDescriptor(e, t, r) {
          "boolean" == typeof t && (t = t ? ee.u.ALL : ee.u.NONE);
          const s = this._renderTargetSystem,
            i = s.getGpuRenderTarget(e),
            n = e.colorTextures.map((e, n) => {
              const o = i.contexts[n];
              let a, u;
              if (o) {
                a = o.getCurrentTexture().createView();
              } else
                a = this._renderer.texture
                  .getGpuSource(e)
                  .createView({ mipLevelCount: 1 });
              i.msaaTextures[n] &&
                ((u = a),
                (a = this._renderer.texture.getTextureView(i.msaaTextures[n])));
              const d = t & ee.u.COLOR ? "clear" : "load";
              return (
          ...
          if (
            ...
            const r = t & ee.u.STENCIL ? "clear" : "load",
              s = t & ee.u.DEPTH ? "clear" : "load";
            o = {
        ...
        clear(e, t = !0, r, s) {
          ...
          const { gpu: i, encoder: n } = this._renderer,
            o = i.device;
          if (null === n.commandEncoder) {
            const i = o.createCommandEncoder(),
              n = this.getDescriptor(e, t, r),
              a = i.beginRenderPass(n);
            a.setViewport(s.x, s.y, s.width, s.height, 0, 1), a.end();
            const u = i.finish();
            o.queue.submit([u]);
        ...
        initGpuRenderTarget(e) {
          ...
          const t = new se();
          return (
            e.colorTextures.forEach((e, r) => {
              if (te.q.test(e.resource)) {
                const s = e.resource.getContext("webgpu"),
                  i = e.transparent ? "premultiplied" : "opaque";
                try {
                  s.configure({
      ...
      class ne extends Z.l {
        constructor(e) {
          super(e), (this.adaptor = new ie()), this.adaptor.init(e, this);
        }
      }
      ne.extension = { type: [s.Ag.WebGPUSystem], name: "renderTarget" };
      class oe {
        constructor() {
        ...
        _createGPUProgramData(e) {
          const t = this._gpu.device,
            r = e.gpuLayout.map((e) => t.createBindGroupLayout({ entries: e })),
      ...
      oe.extension = { type: [s.Ag.WebGPUSystem], name: "shader" };
      const ae = {
        normal: {
          alpha: {
            srcFactor: "one",
      ...
      class ue {
        constructor() {
          (this.defaultState = new x.U()), (this.defaultState.blend = !0);
        }
        contextChange(e) {
          this.gpu = e;
        }
          ...
          return [
            {
              format: "bgra8unorm",
              writeMask: 0,
              blend: ae[e.blendMode] || ae.normal,
            },
          ];
        }
        destroy() {
      ...
      ue.extension = { type: [s.Ag.WebGPUSystem], name: "state" };
      var de = r(1761),
        ce = r(7608);
      const he = {
          type: "image",
          upload(e, t, r) {
            const s = e.resource,
              i = (0 | e.pixelWidth) * (0 | e.pixelHeight),
              n = s.byteLength / i;
        ...
        pe = { blockBytes: 4, blockWidth: 1, blockHeight: 1 },
        fe = {
          type: "compressed",
          upload(e, t, r) {
            let s = e.pixelWidth,
              i = e.pixelHeight;
            const n = le[e.format] || pe;
            for (let o = 0; o < e.resource.length; o++) {
              const a = e.resource[o],
                u = Math.ceil(s / n.blockWidth) * n.blockBytes;
              r.device.queue.writeTexture(
        ...
        ge = {
          ...
          upload(e, t, r) {
            ...
            const i = Math.min(t.width, e.resourceWidth || e.pixelWidth),
              n = Math.min(t.height, e.resourceHeight || e.pixelHeight),
              o = "premultiply-alpha-on-upload" === e.alphaMode;
            r.device.queue.copyExternalImageToTexture(
              { source: s },
      ...
      class _e {
        ...
        generateMipmap(e) {
          ...
          if ("3d" === e.dimension || "1d" === e.dimension)
            throw new Error(
          ...
          if (!i) {
            ...
            for (let s = 1; s < e.mipLevelCount; ++s)
              n.copyTextureToTexture(
                { texture: r, mipLevel: s - 1 },
      ...
      class be {
        ...
        onUpdateMipmaps(e) {
          this._mipmapGenerator ||
            (this._mipmapGenerator = new _e(this._gpu.device));
          const t = this.getGpuSource(e);
        ...
        _initSampler(e) {
          return (
            (this._gpuSamplers[e._resourceId] =
              this._gpu.device.createSampler(e)),
            this._gpuSamplers[e._resourceId]
          );
        }
        getGpuSampler(e) {
        ...
        _createTextureBindGroup(e) {
          const t = e.source,
            r = t.uid;
          return (
            (this._bindGroupHash[r] = new j.T({ 0: t, 1: t.style })),
        ...
        getPixels(e) {
          const t = this.generateCanvas(e),
            r = ce.N.getOptimalCanvasAndContext(t.width, t.height),
            s = r.context;
          s.drawImage(t, 0, 0);
          const { width: i, height: n } = t,
            o = s.getImageData(0, 0, i, n),
            a = new Uint8ClampedArray(o.data.buffer);
          return (
            ce.N.returnCanvasAndContext(r), { pixels: a, width: i, height: n }
          );
        }
        destroy() {
          ...
          for (const e of Object.keys(this._bindGroupHash)) {
            ...
            r?.destroy(), (this._bindGroupHash[t] = null);
          }
          (this._gpu = null),
      ...
      be.extension = { type: [s.Ag.WebGPUSystem], name: "texture" };
      const xe = [...B.i, D, w, M, C, be, ne, oe, ue, J, U, E, S],
        ye = [...B.f, q],
        Ge = [G, b, f],
        Pe = [],
        Be = [],
        ve = [];
      s.XO.handleByNamedList(s.Ag.WebGPUSystem, Pe),
        s.XO.handleByNamedList(s.Ag.WebGPUPipes, Be),
        s.XO.handleByNamedList(s.Ag.WebGPUPipesAdaptor, ve),
        s.XO.add(...xe, ...ye, ...Ge);
      class Se extends P.k {
        constructor() {
          super({
            name: "webgpu",
            type: v.W.WEBGPU,
    ...
    7608: (e, t, r) => {
      ...
      const n = new (class {
        ...
        _createCanvasAndContext(e, t) {
          const r = s.e.get().createCanvas();
          (r.width = e), (r.height = t);
          const i = r.getContext("2d");
          return { canvas: r, context: i };
        }
        getOptimalCanvasAndContext(e, t, r = 1) {
          (e = Math.ceil(e * r - 1e-6)), (t = Math.ceil(t * r - 1e-6));
          const s = ((e = (0, i.U5)(e)) << 17) + ((t = (0, i.U5)(t)) << 1);
