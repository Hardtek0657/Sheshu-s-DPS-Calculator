/*! For license information please see 376.script.js.LICENSE.txt */
"use strict";
    ...
    376: (t, e, i) => {
      ...
      class l {
        ...
        _updateAccessibleObjects(t) {
          ...
          if (e)
            for (let t = 0; t < e.length; t++)
              this._updateAccessibleObjects(e[t]);
        }
        init(t) {
          (this.debug = t?.debug ?? this.debug),
            this._renderer.runners.postrender.remove(this);
        }
        postrender() {
          const t = performance.now();
          if (this._mobileInfo.android.device && t < this._androidUpdateCount)
            return;
          if (
          ...
          const {
            ...
            { width: s, height: r, resolution: a } = this._renderer,
            l = (n / s) * a,
            c = (o / r) * a;
          let d = this._div;
          (d.style.left = `${e}px`),
          ...
          for (let t = 0; t < this._children.length; t++) {
            ...
            if (e._renderId !== this._renderId)
              (e._accessibleActive = !1),
                (0, h.d)(this._children, t, 1),
                this._div.removeChild(e._accessibleDiv),
                this._pool.push(e._accessibleDiv),
              ...
              e.hitArea
                ? ((d.style.left = (i.tx + t.x * i.a) * l + "px"),
                  (d.style.top = (i.ty + t.y * i.d) * c + "px"),
                  (d.style.width = t.width * i.a * l + "px"),
                  (d.style.height = t.height * i.d * c + "px"))
                : ((t = e.getBounds().rectangle),
                  this._capHitArea(t),
                  (d.style.left = t.x * l + "px"),
                  (d.style.top = t.y * c + "px"),
                  (d.style.width = t.width * l + "px"),
                  (d.style.height = t.height * c + "px"),
                  d.title !== e.accessibleTitle &&
                    null !== e.accessibleTitle &&
                    (d.title = e.accessibleTitle || ""),
                  d.getAttribute("aria-label") !== e.accessibleHint &&
                    null !== e.accessibleHint &&
                    d.setAttribute("aria-label", e.accessibleHint || "")),
                (e.accessibleTitle === d.title && e.tabIndex === d.tabIndex) ||
                  ((d.title = e.accessibleTitle || ""),
                  (d.tabIndex = e.tabIndex),
                  this.debug && this._updateDebugHTML(d));
            }
          }
          this._renderId++;
        }
        ...
        _dispatchEvent(t, e) {
          const { container: i } = t.target,
            ...
            o = Object.assign(new r(n), { target: i });
          (n.rootTarget = this._renderer.lastObjectRendered),
            e.forEach((t) => n.dispatchEvent(o, t));
        }
        _onClick(t) {
        ...
        _onKeyDown(t) {
          9 === t.keyCode && this._activate();
        }
        _onMouseMove(t) {
          (0 === t.movementX && 0 === t.movementY) || this._deactivate();
        }
        destroy() {
          this._destroyTouchHook(),
            (this._div = null),
      ...
      const v = new (class {
        ...
        addTickerListener() {
          !this._tickerAdded &&
            this.domElement &&
            (u.R.system.add(this._tickerUpdate, this, p.d.INTERACTION),
            (this._tickerAdded = !0));
        }
        removeTickerListener() {
          this._tickerAdded &&
            (u.R.system.remove(this._tickerUpdate, this),
            (this._tickerAdded = !1));
        }
        pointerMoved() {
          this._didMove = !0;
      ...
      class m extends r {
        ...
        initMouseEvent(t, e, i, n, o, s, r, a, h, l, c, d, p, u, v) {
      ...
      (y.DOM_DELTA_PIXEL = 0), (y.DOM_DELTA_LINE = 1), (y.DOM_DELTA_PAGE = 2);
      const E = new s.b(),
        f = new s.b();
      class _ {
        constructor(t) {
          (this.dispatch = new c.A()),
            (this.moveOnAll = !1),
        ...
        all(t, e, i = this._allInteractiveElements) {
          ...
          for (let e = i.length - 1; e >= 0; e--)
            n.forEach((n) => {
              (t.currentTarget = i[e]), this.notifyTarget(t, n);
            });
        }
        propagationPath(t) {
          const e = [t];
          ...
          if (
            ...
            for (let h = a.length - 1; h >= 0; h--) {
              ...
              if (c) {
                ...
                (c.length > 0 || e) &&
                  (e && this._allInteractiveElements.push(t), c.push(t)),
                  0 === this._hitElements.length && (this._hitElements = c),
                  (r = !0);
              }
            }
          }
        ...
        hitTestRecursive(t, e, i, n, o) {
          if (this._interactivePrune(t) || o(t, i)) return null;
          if (
            (("dynamic" !== t.eventMode && "dynamic" !== e) ||
              (v.pauseUpdate = !1),
            t.interactiveChildren && t.children)
        ...
        hitPruneFn(t, e) {
          if (
            t.hitArea &&
            (t.worldTransform.applyInverse(e, f), !t.hitArea.contains(f.x, f.y))
          )
            return !0;
          if (t.effects && t.effects.length)
            for (let i = 0; i < t.effects.length; i++) {
              const n = t.effects[i];
              if (n.containsPoint) {
                if (!n.containsPoint(e, this.hitTestFn)) return !0;
              }
            }
          return !1;
        }
        hitTestFn(t, e) {
          return (
            !!t.hitArea ||
            (!!t?.containsPoint &&
              (t.worldTransform.applyInverse(e, f), t.containsPoint(f)))
          );
        }
        notifyTarget(t, e) {
          const i = `on${(e = e ?? t.type)}`;
          t.currentTarget[i]?.(t);
          const n =
        ...
        mapPointerMove(t) {
          ...
          if (o !== e.target) {
            ...
            let r = o?.parent;
            for (; r && r !== this.rootTarget.parent && r !== e.target; )
              r = r.parent;
            if (!r || r === this.rootTarget.parent) {
              ...
              for (
                ...
                t.target &&
                t.target !== o &&
                t.target !== this.rootTarget.parent;

              )
                (t.currentTarget = t.target),
                  this.notifyTarget(t),
                  i && this.notifyTarget(t, "mouseenter"),
          ...
          this.moveOnAll
            ...
            r && s.push("globalpointermove"),
            "touch" === e.pointerType &&
              (this.moveOnAll
                ? s.splice(1, 0, "touchmove")
                : this.dispatchEvent(e, "touchmove"),
              r && s.push("globaltouchmove")),
            i &&
              (this.moveOnAll
                ? s.splice(1, 0, "mousemove")
                : this.dispatchEvent(e, "mousemove"),
              r && s.push("globalmousemove"),
        ...
        mapPointerOver(t) {
          ...
          const e = this.trackingData(t.pointerId),
            ...
            n = "mouse" === i.pointerType || "pen" === i.pointerType;
          this.dispatchEvent(i, "pointerover"),
            n && this.dispatchEvent(i, "mouseover"),
            "mouse" === i.pointerType && (this.cursor = i.target?.cursor);
        ...
        mapPointerOut(t) {
          ...
          const e = this.trackingData(t.pointerId);
          if (e.overTargets) {
            const i = "mouse" === t.pointerType || "pen" === t.pointerType,
              n = this.findMountedTarget(e.overTargets),
              o = this.createPointerEvent(t, "pointerout", n);
            ...
            for (
              ...
              (s.currentTarget = s.target),
                this.notifyTarget(s),
                i && this.notifyTarget(s, "mouseleave"),
        ...
        mapPointerUp(t) {
          ...
          const e = performance.now(),
            i = this.createPointerEvent(t);
          if ((this.dispatchEvent(i, "pointerup"), "touch" === i.pointerType))
            this.dispatchEvent(i, "touchend");
          else if ("mouse" === i.pointerType || "pen" === i.pointerType) {
            const t = 2 === i.button;
            this.dispatchEvent(i, t ? "rightup" : "mouseup");
          }
          const n = this.trackingData(t.pointerId),
            o = this.findMountedTarget(n.pressTargetsByButton[t.button]);
          let s = o;
          if (o && !i.composedPath().includes(o)) {
            let e = o;
            for (; e && !i.composedPath().includes(e); ) {
              if (
                ((i.currentTarget = e),
                ...
                const t = 2 === i.button;
                this.notifyTarget(i, t ? "rightupoutside" : "mouseupoutside");
              }
              e = e.parent;
            }
            delete n.pressTargetsByButton[t.button], (s = e);
          }
          if (s) {
            ...
            const r = n.clicksByButton[t.button];
            if (
              (r.target === o.target && e - r.timeStamp < 200
                ? ++r.clickCount
                : (r.clickCount = 1),
              (r.target = o.target),
              (r.timeStamp = e),
              (o.detail = r.clickCount),
              "mouse" === o.pointerType)
            ) {
              const t = 2 === o.button;
              this.dispatchEvent(o, t ? "rightclick" : "click");
            } else "touch" === o.pointerType && this.dispatchEvent(o, "tap");
              ...
              (n.currentTarget = o),
                ...
                "touch" === n.pointerType
                  ...
                  : ("mouse" !== n.pointerType && "pen" !== n.pointerType) ||
                    this.notifyTarget(
                      n,
                      2 === n.button ? "rightupoutside" : "mouseupoutside"
                    ),
                (o = o.parent);
        ...
        createPointerEvent(t, e, i) {
          ...
          return (
            ...
            (n.target =
              i ??
              this.hitTest(n.global.x, n.global.y) ??
              this._hitElements[0]),
          ...
          if (i && t.currentTarget.isInteractive())
            if ("fn" in i)
              ...
              for (
                ...
                i[n].once &&
                  t.currentTarget.removeListener(e, i[n].fn, void 0, !0),
        ...
        T = class t {
          constructor(e) {
            (this.supportsTouchEvents = "ontouchstart" in globalThis),
              ...
              (this.resolution = 1),
              (this.renderer = e),
              (this.rootBoundary = new _(null)),
              v.init(this),
              (this.autoPreventDefault = !0),
              (this._eventsAdded = !1),
              (this._rootPointerEvent = new g(null)),
              (this._rootWheelEvent = new y(null)),
          ...
          init(e) {
            ...
            this.setTargetElement(i),
              (this.resolution = n),
              (t._defaultEventMode = e.eventMode ?? "passive"),
          ...
          _onPointerDown(t) {
            ...
            for (let t = 0, i = e.length; t < i; t++) {
              const i = e[t],
                n = this._bootstrapEvent(this._rootPointerEvent, i);
          ...
          _onPointerMove(t) {
            ...
            const e = this._normalizeToPointerData(t);
            for (let t = 0, i = e.length; t < i; t++) {
              const i = this._bootstrapEvent(this._rootPointerEvent, e[t]);
          ...
          _onPointerUp(t) {
            ...
            for (let t = 0, e = n.length; t < e; t++) {
              const e = this._bootstrapEvent(this._rootPointerEvent, n[t]);
              (e.type += i), this.rootBoundary.mapEvent(e);
            }
            this.setCursor(this.rootBoundary.cursor);
          }
          _onPointerOverOut(t) {
          ...
          mapPositionToPoint(t, e, i) {
            const n = this.domElement.isConnected
              ...
              o = 1 / this.resolution;
            (t.x = (e - n.left) * (this.domElement.width / n.width) * o),
              (t.y = (i - n.top) * (this.domElement.height / n.height) * o);
          }
          _normalizeToPointerData(t) {
            ...
            if (this.supportsTouchEvents && t instanceof TouchEvent)
              ...
              void 0 === i.isPrimary && (i.isPrimary = !0),
                ...
                void 0 === i.pointerId && (i.pointerId = 1),
          ...
          _bootstrapEvent(t, e) {
            return (
              ...
              t.type.startsWith("touch") && (t.type = b[t.type] || t.type),
              t
            );
          }
      ...
      (T.extension = {
        name: "events",
        type: [n.Ag.WebGLSystem, n.Ag.CanvasSystem, n.Ag.WebGPUSystem],
        priority: -1,
      }),
        (T.defaultEventFeatures = {
          move: !0,
      ...
      const w = {
        ...
        get eventMode() {
          return this._internalEventMode ?? P.defaultEventMode;
        },
        set eventMode(t) {
        ...
        addEventListener(t, e, i) {
          const n =
              ("boolean" == typeof i && i) ||
              ("object" == typeof i && i.capture),
            o = "object" == typeof i ? i.signal : void 0,
            s = "object" == typeof i && !0 === i.once,
            r = "function" == typeof e ? void 0 : e;
          t = n ? `${t}capture` : t;
          const a = "function" == typeof e ? e : e.handleEvent,
            h = this;
          o &&
            o.addEventListener("abort", () => {
              h.off(t, a, r);
            }),
            s ? h.once(t, a, r) : h.on(t, a, r);
        },
        removeEventListener(t, e, i) {
          const n = "function" == typeof e ? void 0 : e;
          (t =
            ("boolean" == typeof i && i) || ("object" == typeof i && i.capture)
              ? `${t}capture`
              : t),
